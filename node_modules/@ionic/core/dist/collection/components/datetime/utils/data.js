...
export const getYearColumnData = (refParts, minParts, maxParts, yearValues) => {
  let processedYears = [];
 ...
 * Example: "Thu, Jun 2"
 */
export const getCombinedDateColumnData = (locale, refParts, todayParts, minParts, maxParts, dayValues, monthValues) => {
  let items = [];
  let parts = [];
  /**
...
export const getTimeColumnsData = (locale, refParts, hourCycle, minParts, maxParts, allowedHourValues, allowedMinuteVaues) => {
